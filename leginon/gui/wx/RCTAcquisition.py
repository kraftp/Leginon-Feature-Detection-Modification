...
class ScrolledSettings(leginon.gui.wx.Acquisition.ScrolledSettings):
        ...
        def addRCTSettings(self):
                ...
                self.widgets['stepsize'] = IntEntry(self, -1, chars=2, value='60')
                ...
                sizer.Add(self.widgets['drift threshold'], (2,1), (1,1), wx.ALL|wx.ALIGN_CENTER_VERTICAL, bordersize)
                ...
                sizer.Add(self.widgets['drift preset'], (2,3), (1,1), wx.ALL|wx.ALIGN_CENTER_VERTICAL, bordersize)
